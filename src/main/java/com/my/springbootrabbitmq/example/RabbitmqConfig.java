package com.my.springbootrabbitmq.example;
...
public class RabbitmqConfig {
    ...
    public DirectExchange logUserExchange(){
        return new DirectExchange(env.getProperty("log.user.exchange.name"));
    }

    @Bean
    public Binding logUserBinding(Queue logUserQueue, DirectExchange logUserExchange){
